      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1.5">
            Launch high-converting landing pages for your apps in minutes
          </p>
        </div>
        ...
        <div className="bg-white/80 dark:bg-zinc-950/70 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 rounded-2xl p-7 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)]">
          ...
          {successMessage && (
            <div className="mb-5 p-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200/60 dark:border-emerald-900/40 text-xs text-emerald-700 dark:text-emerald-400 flex items-start gap-2">
